...
import type { FileInfo, Provider } from '../../shared/types.js'
import { worker as PluginFileServiceRPC, workerGenerator as PluginFileServiceRPCGenerator } from '@masknet/plugin'
