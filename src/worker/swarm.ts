...
import { Bee, type CollectionEntry } from '@ethersphere/bee-js'
import { landing } from '../shared/constants.js'
import type { ProviderAgent, LandingPageMetadata, AttachmentOptions } from '../shared/types.js'
import { makeFileKeySigned } from '../shared/helpers.js'

const POSTAGE_STAMP = '0'.repeat(64)
const BEE_HOSTS = times(10, (n) => `https://gateway-proxy-bee-${n}-0.gateway.ethswarm.org`)
const BEE_HOST = sample(BEE_HOSTS)!
